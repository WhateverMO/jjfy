...
def calculate_final_scores(questionnaire_counts, module_total=100):
    """
    输入：
        questionnaire_counts: 二维列表，每题是选项计数，如 [[10,5], [20,1,6,5], ...]
        section_indices: 每个模块包含题目索引的列表，如 [[0,2,3], [1,4,5]]
    ...
    for sec_idx, indices in enumerate(SECTION_INDICES, 1):
        for idx in indices:
